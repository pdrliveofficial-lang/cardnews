...
- **스레드 글 원칙 (2026-08-02 사용자 피드백 반영)**: ①본문에서 기승전결 완결 — "링크로 오라"는 유도 금지 ②1인칭 극대노/황당 톤, 구체적 상황+어이없는 대사+되묻기 마무리 ③이미지 첨부 금지(홍보물처럼 보여 이탈) ④A/B 객관식 금지 ⑤인스타 유도는 셀프 답글로만. 참고 벤치마크: @he.uiui (59만 조회, 시리즈물+고정댓글 제품 언급).
